...
@section('content')
	...
	<div class="content">
		<div class="animated fadeIn">
				...
				<div class="float_item">
					<nav aria-label="breadcrumb">						
		  				<ol class="breadcrumb">		  					
		    				...
		    				<li class="breadcrumb-item active" aria-current="page">Workout plan</li>
		  				</ol>
					</nav>
				</div>
			</div>
			...
			<div class="card">
				<div class="card-body">
					<form action="{{ route('create_workout_plan') }}" method="post" accept-charset="utf-8">
						@csrf
						...
						<div class="form-group">
							...
							<textarea name="workout_plan" class="form-control @error('workout_plan') is-invalid @enderror">{{ old('workout_plan') }}</textarea>
							@error('workout_plan') 
							    <div class="invalid-feedback font-weight-bold" style="padding: 0;">{{ $message }}</div>
							@enderror
						</div>
